...
export default class DubStep extends Component {
    ...
    constructor() {
        super();
        this.state = {
            image: 'http://rina.jpn.ph/~rance/directx7/directx7study/ddraw/img/img15_1.gif'
        }
    }
    ...
    playSong() {
        ...
        const play_soundA = (async () => {
            ...
            await soundA.loadAsync(require('../assets/bgm.mp3'));
    ...
    playA() {
        ...
        const play_soundA = (async () => {
            ...
            await soundA.loadAsync(require('../assets/se1.mp3'));
            await soundA.playAsync();
    ...
    playB() {
        ...
        const play_soundB = (async () => {
            ...
            await soundB.loadAsync(require('../assets/se2.mp3'));
    ...
    playC() {
        ...
        const play_soundC = (async () => {
            ...
            await soundC.loadAsync(require('../assets/se3.mp3'));
    ...
    playD() {
        ...
        const play_soundD = (async () => {
            ...
            await soundD.loadAsync(require('../assets/se4.mp3'));
    ...
    playE() {
        ...
        const play_soundE = (async () => {
            ...
            await soundE.loadAsync(require('../assets/se5.mp3'));
    ...
    playF() {
        ...
        const play_soundF = (async () => {
            ...
            await soundF.loadAsync(require('../assets/se6.mp3'));
    ...
    playG() {
        ...
        const play_soundG = (async () => {
            ...
            await soundG.loadAsync(require('../assets/se7.mp3'));
