...
export default class DubStep extends Component {
    ...
    constructor() {
        super();
        this.state = {
            image: 'https://i.ytimg.com/vi/nGqPwzi-g_c/maxresdefault.jpg'
        }
    }
    ...
    playSong() {
        ...
        const play_soundA = (async () => {
            ...
            await soundA.loadAsync(require('../assets/gaur.mp3'));
    ...
    playA() {
        ...
        const play_soundA = (async () => {
            ...
            await soundA.loadAsync(require('../assets/game1.mp3'));
            await soundA.playAsync();
    ...
    playB() {
        ...
        const play_soundB = (async () => {
            ...
            await soundB.loadAsync(require('../assets/game2.mp3'));
    ...
    playC() {
        ...
        const play_soundC = (async () => {
            ...
            await soundC.loadAsync(require('../assets/game3.mp3'));
    ...
    playD() {
        ...
        const play_soundD = (async () => {
            ...
            await soundD.loadAsync(require('../assets/game4.mp3'));
    ...
    playE() {
        ...
        const play_soundE = (async () => {
            ...
            await soundE.loadAsync(require('../assets/game5.mp3'));
    ...
    playF() {
        ...
        const play_soundF = (async () => {
            ...
            await soundF.loadAsync(require('../assets/game6.mp3'));
    ...
    playG() {
        ...
        const play_soundG = (async () => {
            ...
            await soundG.loadAsync(require('../assets/game7.mp3'));
